...
export const mockDocuments: Document[] = [
  {
    id: 1,
    title: "Effects of Ocrelizumab on Fatigue in Patients with Multiple Sclerosis",
    abstract: "This study investigates the impact of Ocrelizumab treatment on fatigue levels in patients with multiple sclerosis...",
    date: "2023-03-15",
    ...
    pico: {
      ...
      comparator: "Placebo",
      outcome: "Changes in fatigue levels",
      expanded: false
    }
  },
  {
    ...
    abstract: "This meta-analysis examines the effectiveness of ocrelizumab in reducing relapse rates in patients with relapsing-remitting multiple sclerosis...",
    date: "2023-04-02",
