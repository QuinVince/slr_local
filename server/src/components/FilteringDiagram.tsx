...
const FilteringDiagram: React.FC<FilteringDiagramProps> = ({ initialData }) => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-6 text-gray-800">PRISMA Flow Diagram</h1>
      ...
      <div className="mt-6">
        <button
          ...
          className="px-4 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 flex items-center"
        >
