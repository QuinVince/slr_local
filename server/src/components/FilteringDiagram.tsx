...
const FilteringDiagram: React.FC<FilteringDiagramProps> = ({ initialData }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      <h1 className="text-2xl font-bold mb-6 text-[#62B6CB] flex items-center"> 
      ...
      <div className="mt-6">
        <button
          ...
          className="px-4 py-2 bg-[#62B6CB] text-white rounded hover:bg-[#62B6CB] focus:outline-none focus:ring-2 focus:ring-[#62B6CB] focus:ring-offset-2 flex items-center"
        >
